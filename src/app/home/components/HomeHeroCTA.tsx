  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <motion.div
          className="absolute -left-3 -top-3 w-12 h-12 border-l-2 border-t-2 border-white/70"
        ...
        <Button
          ...
          size="lg"
          href={ctaLink}
          className="text-lg group relative overflow-hidden border-2 border-brand-primary hover:border-white transition-all z-10"
          icon={
        ...
        >
          ...
          <span className="absolute inset-0 bg-accent-contrast transform translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
        </Button>
        ...
        >
          <div className="flex flex-col items-center justify-center">
            <div className="w-6 h-px bg-accent-primary"></div>
            <div className="w-px h-6 bg-accent-primary"></div>
            <div className="absolute h-1 w-1 bg-white rounded-full"></div>
            <div className="absolute top-3 text-[8px] font-mono text-accent-primary">01</div>
          </div>
        </motion.div>
      </div>
      ...
      >
        <span className="h-4 w-px bg-brand-primary animate-pulse"></span>
        <span>CMD://</span>
        <span className="text-brand-primary">initialize_project</span>
