...
module.exports = {
    ...
    theme: {
        extend: {
            colors: {
                ...
                "bg-tooltip": "var(--color-tooltip-bg)",
                "bg-dropdown": "var(--color-dropdown-bg)",
                "bg-selection": "var(--color-selection-bg)",

                "text-primary": "var(--color-text-primary)",
                "text-secondary": "var(--color-text-secondary)",
                "text-tertiary": "var(--color-text-tertiary)", // Fixed - added --color- prefix
                "text-disabled": "var(--color-text-disabled)",
                "text-on-accent": "var(--color-text-on-accent)",
                "text-code": "var(--color-text-code)", // Added
                "text-emphasis": "var(--color-text-emphasis)", // Added
                "text-inverted": "var(--color-text-inverted)", // Added
                "heading": "var(--color-heading)",
                "heading-accent": "var(--color-heading-accent)",
                "subheading": "var(--color-subheading)", // Added
                ...
                "divider-stroke": "var(--color-divider)", // Fixed - using correct variable
                ...
                "interactive-secondary": "var(--color-interactive-secondary)", // Added
                "interactive-secondary-hover": "var(--color-interactive-secondary-hover)", // Added
                "interactive-secondary-active": "var(--color-interactive-secondary-active)", // Added
                ...
                "accent-warm": "var(--color-accent-warm)", // Added
                ...
                "success-text": "var(--color-success-text)", // Added
                "warning": "var(--color-warning)",
                "warning-subtle": "var(--color-warning-subtle)",
                "warning-text": "var(--color-warning-text)", // Added
                "error": "var(--color-error)",
                "error-subtle": "var(--color-error-subtle)",
                "error-text": "var(--color-error-text)", // Added
                "info": "var(--color-info)",
                "info-subtle": "var(--color-info-subtle)",
                "info-text": "var(--color-info-text)", // Added
                ...
                "emphasis": "var(--color-emphasis)", // Added
                ...
                "field-placeholder": "var(--color-field-placeholder)",
                "field-focus": "var(--color-field-focus)",
                "field-required": "var(--color-field-required)",
                "field-invalid": "var(--color-field-invalid)",

                // Additional design-focused colors (kept as is)
    ...
    plugins: [
        typography, // @tailwindcss/typography plugin already imported at the top
    ],
};